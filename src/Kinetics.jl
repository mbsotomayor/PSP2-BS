function calculate_transcription_kinetics(t::Float64, x::Array{Float64,1}, problem::Dict{String,Any})::Float64
    ...
    transcription_rate = Vmax_X*(G/((tau_X*KX)+((tau_X+1)*G)))  #(gen_concentration/((tau_X*KX)+((tau_X+1)*gen_concentration)))
...
function calculate_mRNA_degradation_kinetics(t::Float64, x::Array{Float64,1},
    problem::Dict{String,Any})::Float64
